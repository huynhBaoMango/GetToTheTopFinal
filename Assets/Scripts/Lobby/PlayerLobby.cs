...
public class PlayerLobby : NetworkBehaviour
{
    ...
    private readonly SyncVar<bool> playerReadyCurrent = new SyncVar<bool>();
    private readonly SyncVar<string> playerNameCurrent = new SyncVar<string>();
   ...
   private void Awake()
    {
        playerNameCurrent.OnChange += OnChangePlayerName;
        playerReadyCurrent.OnChange += OnChangePlayerReady;
    }
    ...
    private void OnChangePlayerName(string oldValue, string newValue, bool isServer)
    {
        if (!isServer)
        {
